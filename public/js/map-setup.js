  ...
  async function getPatients () {
    ...
    myJson.map(patient=> {
      ...
      if(document.getElementById("patient-map")) {
          let patientMap = L.map('patient-map').setView([42.639885, 20.891453], 11);
          ...
          * **/
          ...
          for (i = 0; i < patients.length; i++) {
              console.log(' mergim');
              L.marker([patients[i].latitude, patients[i].longitude], {icon: highIcon}).addTo(patientMap)
                  .bindPopup("<div class='map-popup" + ' ' + criticalHighIcon + "'>" +
                      "              <div class='user-image'>" +
                      "                  <img src=" + patients[i].imageUrl +">" +
                      "              </div>" +
                      "              <div class='info'>" +
                      "                  <h4>" + patients[i].name +"</h4>" +
